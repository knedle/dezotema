# Konspirace — Deep State a QAnon

Témata: QAnon, EBS, MedBeds, biolaboratoře, falešní mesiášové, Deep State a jeho svržení. Vyčleněno z [Konspirační teorie](konspirace.md).
...
**26. 7.** — Vrabel zasazuje tutéž tezi do dlouhého historicko-náboženského rámce: skutečný civilizační konflikt je podle něj starý jako Byzantská a Římská říše — římská (katolická) linie zavedla prodej odpustků (dle Vrabela „úplatkářství") a převzala od židovské tradice bankovní systém založený na úrocích (na rozdíl od islámského bankovnictví, kde jsou úroky zakázané, i pravoslaví, které úročení odmítá). Tvrdí, že katolická církev dodnes kanonizuje válečné zločince a po 2. světové válce je schovávala ve Vatikánu — jako příklad uvádí chorvatský koncentrační tábor Jasenovac, který měl za 2. světové války sloužit k vyvražďování pravoslavných Srbů. Dodává obvinění z rozšířené pedofilie v katolické církvi včetně tvrzení o nalezených dětských kosterních pozůstatcích v klášterech. Z toho vyvozuje, že „chazarští Židé" v USA jsou pokračovateli téže římsko-bankéřské linie, řídí globalizaci skrze WTO, MMF a Světovou banku od 50. let minulého století a jejich moc se přesouvala mezi centry (Nizozemsko → Británie 1944 → USA) podle toho, kde se tiskla světová rezervní měna.

**Zdroje:** [Vrabel — Zprávy v devět 6. 6. 2026](_zdroje.md#ladislav-vrabel--zprávy-v-devět-6-6-2026), [Vrabel — Zprávy v devět 23. 7. 2026](_zdroje.md#ladislav-vrabel--zprávy-v-devět-23-7-2026), [Vrabel — Nedělní vysílání 26. 7. 2026](_zdroje.md#ladislav-vrabel--nedělní-vysílání-26-7-2026)
...
Navazuje na [Trump, Putin a Xi jako aliance](#trump-putin-a-xi-jako-koordinovaná-aliance-proti-deep-state--zítko-čte-mcintosh), [Rodný list jako obchodní papír](konspirace-ceskoslovensko.md#rodný-list-jako-obchodní-papír-na-burze-v-new-yorku--admirality-law-zítko) a [Válečné reparace a výzva mocnostem](konspirace-ceskoslovensko.md#válečné-reparace-a-výzva-mocnostem-obnovit-čsr-zítko-3-6-2026).
...
**14. 9.** — V delší, plnější verzi téhož vysílání Zítko doplňuje řadu nových detailů. Cituje komentář „Jardy Štefce": budova WTC7 (zřícená za 6,5 sekundy bez zásahu letadla) obsahovala utajované archivy CIA, FBI, U.S. Secret Service a SEC (Komise pro cenné papíry a burzy) s vyšetřovacími spisy k velkým finančním podvodům na Wall Street — jejich zničení mělo ušetřit tehdejšímu vedení USA „velké bolení hlavy". Nájemce Larry Silverstein si komplex pronajal jen dva měsíce před útokem (červenec 2001) a od pojišťoven obdržel dvojí plnění (celkem 4,6 mld. USD) na základě výkladu, že šlo o dvě nezávislé události — sám se prý toho dne vyhnul své obvyklé snídani na střeše kvůli návštěvě dermatologa. Zítko propojuje událost s potopením Titanicu (bankéři odpůrci soukromého Fedu, mj. John Jacob Astor, zahynuli poté, co J. P. Morgan svou účast na poslední chvíli zrušil) jako analogický „pojišťovací podvod". Ironicky poznamenává, že Usáma bin Ládin byl po deseti letech intenzivního satelitního pátrání v afghánských horách nakonec nalezen „doma" — skutečným cílem invaze do Afghánistánu byla dle Zítka a Štefce snaha oslabit Rusko a Čínu, ne dopadení bin Ládina. Doplňuje také starší tezi o dětech-sirotcích z válečných konfliktů (Afghánistán, Irák) jako zdroji pro mučení a výrobu adrenochromu.
